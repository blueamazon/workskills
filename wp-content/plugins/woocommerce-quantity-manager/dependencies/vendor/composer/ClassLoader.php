 ...
 */
namespace Barn2\Plugin\WC_Quantity_Manager\Dependencies\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('Barn2\\Plugin\\WC_Quantity_Manager\\Dependencies\\HHVM_VERSION')) {
