 ...
 */
namespace Barn2\Plugin\WC_Quantity_Manager\Dependencies\Barn2\Setup_Wizard;

use Barn2\Plugin\WC_Quantity_Manager\Dependencies\Barn2\Setup_Wizard\Interfaces\Bootable;
...
class Setup_Wizard implements Bootable
{
    ...
    {
        $defaults = ['plugin_name' => $this->plugin->get_name(), 'plugin_slug' => $this->plugin->get_slug(), 'plugin_product_id' => $this->plugin::ITEM_ID, 'skip_url' => admin_url(), 'license_tooltip' => '', 'utm_id' => '', 'completed' => $this->is_completed()];
