...
/* custom-files.twig */
class __TwigTemplate_fe2554c2155ad038b55b46c66379468002973c90da37458df92915cce49698c2 extends \WCML\Twig\Template
{
...
<div class=\"wcml-downloadable-options\">
    ...
    <label for=\"wcml_file_path_option\">";
        // line 8
        echo \WCML\twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "use_custom", []), "html", null, true);
        echo "</label>
    ...
    <ul ";
        ...
        // line 14
        echo \WCML\twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "use_same", []), "html", null, true);
        echo "</label>
        </li>
        <li>
            <input type=\"radio\" name=\"wcml_file_path_sync[";
        ...
        // line 19
        echo \WCML\twig_escape_filter($this->env, $this->getAttribute(($context["strings"] ?? null), "separate", []), "html", null, true);
        echo "</label>
        </li>
    </ul>
    <p></p>
...
";
    ...
    {
        return new Source("", "custom-files.twig", "/home/customer/www/nextgates.se/public_html/educations/wp-content/plugins/woocommerce-multilingual/templates/custom-files.twig");
    }
}
