...
<div class="course_description" id="course-home">
	<?php if(!empty($post->post_excerpt) && strpos($post->post_content,$post->post_excerpt) === false){ echo '<span>';the_excerpt(); echo '</span>';} // span is replaced eith former h6 tag by Anas ?> 
